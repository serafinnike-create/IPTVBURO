...
value class ContentIdentity(val key: String) {
    ...
    companion object {
        ...
        fun slugify(title: String): String {
            ...
            // Decomposed per platform, then stripped of the marks that come loose.
            //
            // The decomposition is the one piece of this that has no common implementation: the JVM
            // has java.text.Normalizer and iOS has its own. It is behind expect/actual rather than
            // reimplemented in common code because this function is what every favourite, reminder
            // and resume point on every existing installation is keyed by — a stem that came out
            // even slightly different would silently orphan all of it.
            val decomposed = decomposeForFolding(withoutBrackets)
