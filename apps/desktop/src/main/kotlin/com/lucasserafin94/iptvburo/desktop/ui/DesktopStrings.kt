                ...
                shareStrings =
                    ...
                    screens =
                        ScreenStrings(
                            ...
                            subscriptionDaysLeft = "Lista: %1${'$'}d días · %2${'$'}s",
                            subscriptionLastDay = "Lista: último día · %s",
                            subscriptionExpired = "Lista vencida · %s",
                            ...
                            guideNow = "Ahora",
                            guideNext = "A continuación",
                            catchUpShow = "Rever (%1${'$'}s)",
                            resumeFromTime = "Continuar desde %s",
                    ...
                    cache =
                        CacheStrings(
                            title = "Guardar las portadas en este equipo",
                            explanation = "La app guarda las portadas y las imagenes en tu equipo para que la lista se abra al instante, sin descargarlo todo cada vez.",
                            firstTimeWarning = "La primera vez puede tardar: depende del tamano de tu lista. La descarga ocurre en segundo plano y puedes usar la app con normalidad.",
                            sizeLabel = "Espacio reservado",
                            gigabytes = "%d GB",
                            disabled = "No guardar",
                            estimate = "Tu lista necesita aproximadamente %s.",
                            start = "Empezar",
                            skip = "Ahora no",
                            filling = "Guardando portadas",
                            progress = "%1${'$'}d de %2${'$'}d",
                            pause = "Pausar",
                            resume = "Continuar",
                            cancel = "Cancelar",
                            complete = "Todo guardado.",
                            used = "En uso: %s",
                            clear = "Limpiar cache",
                            ...
                            restartNote = "Cambiar el tamano se aplica la proxima vez que abras la app.",
                            percent = "%d%%",
                            refresh = "Actualizar",
                        ),
                    serviceCatalogue =
                ...
                shareStrings =
                    ...
                    screens =
                        ScreenStrings(
                            ...
                            subscriptionDaysLeft = "Lista: %1${'$'}d dias · %2${'$'}s",
                            subscriptionLastDay = "Lista: último dia · %s",
                            subscriptionExpired = "Lista vencida · %s",
                            diagnosticsAction = "Diagnóstico",
                ...
                shareStrings =
                    ...
                    screens =
                        ScreenStrings(
                            ...
                            subscriptionDaysLeft = "Playlist: %1${'$'}d days · %2${'$'}s",
                            subscriptionLastDay = "Playlist: last day · %s",
                            subscriptionExpired = "Playlist expired · %s",
                ...
                shareStrings =
                    ...
                    screens =
                        ScreenStrings(
                            ...
                            subscriptionDaysLeft = "Liste: %1${'$'}d Tage · %2${'$'}s",
                            subscriptionLastDay = "Liste: letzter Tag · %s",
                            subscriptionExpired = "Liste abgelaufen · %s",
                            ...
                            resumeFromTime = "Fortsetzen ab %s",
                ...
                shareStrings =
                    ...
                    screens =
                        ScreenStrings(
                            ...
                            subscriptionDaysLeft = "Lista: %1${'$'}d giorni · %2${'$'}s",
                            subscriptionLastDay = "Lista: ultimo giorno · %s",
                            subscriptionExpired = "Lista scaduta · %s",
...
data class ScreenStrings(
    ...
    /**
     * Forgets every list that is not answering, in one press.
     *
     * A subscription that has expired or moved leaves a row that will never work again, and after a
    ...
    /** The details page's play button when the title is part-watched. Takes the clock. */
    val resumeFromTime: String,
    /** The details page's play button when the title was finished and is opened again. */
