...
- Tag mais recente no repositório atual: `v3.1.0`
- Releases publicadas: `v2.0.0-alpha.7`, `v2.0.0-alpha.11`, `v2.0.0-alpha.12`
  como prévia; `v3.0.0`, `v3.0.1`, `v3.0.3`, `v3.0.4`, `v3.0.5`, `v3.0.6` e `v3.1.0` como versões finais do Windows
  (a `v3.0.2` foi despublicada: atualizar por ela apagava o aplicativo)
- Windows: `v3.1.0`; MSI ainda sem assinatura Authenticode
