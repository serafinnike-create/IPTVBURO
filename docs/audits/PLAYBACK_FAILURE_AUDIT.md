...
| loading/primeiro frame | eventos Media3 | estado VLC por loopback local | existente |
| play, pause e volume | real | real | existente |
| seek e velocidade | conforme mídia | seek e 0,5×–2× pelo VLC | existente |
...
| HEVC/Dolby Vision | depende do dispositivo | HEVC validado; Dolby Vision depende de hardware/stream | parcial |
...
Conclusão: Android e Windows possuem verticais reproduzíveis. A matriz completa
ainda precisa de hardware e amostras públicas; seleção ampla de faixas e HDR
continuam necessários antes de declarar o player AAA.
