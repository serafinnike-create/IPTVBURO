...
![Windows](https://img.shields.io/badge/Windows-v3.0.2-e2b458)
...
| Aplicação Windows | ✅ `v3.0.2`; MSI ainda sem assinatura Authenticode |
...
**➜ [Página da versão v3.0.2](https://github.com/serafinnike-create/IPTVBURO/releases/tag/v3.0.2)**
