...
![Windows](https://img.shields.io/badge/Windows-v3.3.0-e2b458)
...
| Aplicação Windows | ✅ `v3.3.0`; MSI ainda sem assinatura Authenticode |
...
**➜ [Página da versão v3.3.0](https://github.com/serafinnike-create/IPTVBURO/releases/tag/v3.3.0)**
· [todas as versões](https://github.com/serafinnike-create/IPTVBURO/releases)

| Plataforma | Baixar |
|---|---|
| Windows 10/11 (64 bits) | [`IPTV-BURO-v3.3.0-windows-x64.msi`](https://github.com/serafinnike-create/IPTVBURO/releases/download/v3.3.0/IPTV-BURO-v3.3.0-windows-x64.msi) — sem assinatura, veja a nota abaixo |
...
O [`SHA256SUMS.txt`](https://github.com/serafinnike-create/IPTVBURO/releases/download/v3.3.0/SHA256SUMS.txt)
