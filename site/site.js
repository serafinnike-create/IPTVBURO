(() => {
  ...
  const pt = {
    ...
    demoKicker: 'DEMONSTRAÇÃO INTERATIVA', demoTitle: 'Cinco telas. Uma biblioteca.', demoLead: 'Escolha uma função ou deixe a apresentação avançar sozinha. É assim que o IPTV BURO organiza uma fonte real depois da importação.',
    demoHome: 'Início', demoHomeSub: 'Sua noite, pronta', demoLive: 'Ao vivo', demoLiveSub: 'Agora e a seguir', demoMovies: 'Filmes', demoMoviesSub: 'Capas e detalhes', demoSeries: 'Séries', demoSeriesSub: 'Temporadas organizadas', demoMultiSub: 'Até quatro canais', pauseTour: 'Pausar apresentação', resumeTour: 'Retomar apresentação', demoConnected: 'Fonte conectada', play: 'Assistir', details: 'Detalhes',
    ...
    platformsKicker: 'PLATAFORMAS', platformsTitle: 'Comece onde já funciona.', platformsLead: 'As versões atuais são prévias. Novas plataformas só aparecem como disponíveis depois de validação real.', windowsBody: 'Player integrado, catálogo completo, Multiview e atualizações verificadas.', androidBody: 'Aplicativo adaptativo com Media3, perfis, catálogo e reprodução.', previewAvailable: 'Prévia disponível', nextPlatforms: 'Outras plataformas', nextPlatformsBody: 'Fire TV, Apple, Samsung, LG e mais fazem parte do roteiro, não da promessa atual.', planned: 'Planejado', seeReleases: 'Ver versões disponíveis no GitHub',
  ...
  const en = {
    ...
    demoKicker: 'INTERACTIVE DEMO', demoTitle: 'Five screens. One library.', demoLead: 'Choose a feature or let the tour advance on its own. This is how IPTV BURO organizes a real source after import.', demoHome: 'Home', demoHomeSub: 'Your evening, ready', demoLive: 'Live TV', demoLiveSub: 'Now and next', demoMovies: 'Movies', demoMoviesSub: 'Artwork and details', demoSeries: 'Series', demoSeriesSub: 'Organized seasons', demoMultiSub: 'Up to four channels', pauseTour: 'Pause tour', resumeTour: 'Resume tour', demoConnected: 'Source connected', play: 'Play', details: 'Details',
  ...
  const de = {
    ...
    demoKicker: 'INTERAKTIVE DEMO', demoTitle: 'Fünf Ansichten. Eine Mediathek.', demoLead: 'Wähle eine Funktion oder lass die Tour automatisch weiterlaufen. So organisiert IPTV BURO eine echte Quelle nach dem Import.', demoHome: 'Start', demoHomeSub: 'Dein Abend ist bereit', demoLive: 'Live-TV', demoLiveSub: 'Jetzt und danach', demoMovies: 'Filme', demoMoviesSub: 'Cover und Details', demoSeries: 'Serien', demoSeriesSub: 'Geordnete Staffeln', demoMultiSub: 'Bis zu vier Sender', pauseTour: 'Tour pausieren', resumeTour: 'Tour fortsetzen', demoConnected: 'Quelle verbunden', play: 'Abspielen', details: 'Details',
    ...
    screensKicker: 'EINE SPRACHE, VIELE BILDSCHIRME', screensTitle: 'Dieselbe Ruhe,<br>wo immer du bist.', screensBody: 'Navigation, Dichte und Steuerung passen sich an, ohne die Identität des Produkts zu verlieren.', platformsTitle: 'Starte dort, wo es bereits funktioniert.', platformsLead: 'Die aktuellen Versionen sind Vorschauen. Neue Plattformen gelten erst nach echter Validierung als verfügbar.', windowsBody: 'Integrierter Player, vollständiger Katalog, Multiview und verifizierte Updates.', androidBody: 'Adaptive Media3-App mit Profilen, Katalog und Wiedergabe.', previewAvailable: 'Vorschau verfügbar', nextPlatforms: 'Weitere Plattformen', nextPlatformsBody: 'Fire TV, Apple, Samsung, LG und weitere stehen auf der Roadmap, sind aber noch kein aktuelles Versprechen.', planned: 'Geplant', seeReleases: 'Verfügbare Versionen auf GitHub ansehen',
  ...
  const it = {
    ...
    demoKicker: 'DEMO INTERATTIVA', demoTitle: 'Cinque schermate. Una libreria.', demoLead: 'Scegli una funzione o lascia avanzare il tour. Ecco come IPTV BURO organizza una fonte reale dopo l’importazione.', demoHome: 'Home', demoHomeSub: 'La tua serata è pronta', demoLive: 'In diretta', demoLiveSub: 'Ora e dopo', demoMovies: 'Film', demoMoviesSub: 'Copertine e dettagli', demoSeries: 'Serie', demoSeriesSub: 'Stagioni organizzate', demoMultiSub: 'Fino a quattro canali', pauseTour: 'Metti in pausa il tour', resumeTour: 'Riprendi il tour', demoConnected: 'Fonte collegata', play: 'Riproduci', details: 'Dettagli',
  ...
  function restartTour() {
    ...
    if (!demoPaused) {
      ...
      demoTimer = window.setInterval(() => {
        const names = ['home', 'live', 'movies', 'series', 'multiview'];
